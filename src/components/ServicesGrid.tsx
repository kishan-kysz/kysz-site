...
const technologies: Technology[] = [
  ...
  },
  {
    name: 'OpenAI',
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-900">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-6">
          {technologies.map((tech, index) => (
            <motion.div
              ...
              className={`${tech.bgColor} rounded-xl p-4 sm:p-6 aspect-square flex flex-col items-center justify-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1`}
            >
              <div className="text-gray-800 mb-2 sm:mb-3 flex items-center justify-center h-12 sm:h-16">
                {tech.icon}
              </div>
