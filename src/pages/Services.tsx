          ...
          {services.map((service, index) => (
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  <ul className="space-y-3 mb-8">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start">
                        <svg className="w-5 h-5 text-[#6C63FF] mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-gradient-to-br from-[#E8E4FF] to-[#F3F1FF] rounded-2xl p-12 h-80 flex items-center justify-center">
